...
{if $recettes|default:''}
	...
	<div id="liste_recettes">
		{foreach $recettes as $line}
			<div class="recette">
				<p><a href="{base_url('index.php/recettes/detail_recette/'|cat:$line->id_recette)}"><img class="img_recette" src="{base_url('images/default/recette.png')}" alt="Illustration recette" height="150" width="150" /></a></p>
				...
				<p class="texte_recette">{$line->recette} <a href="{base_url('index.php/recettes/detail_recette/'|cat:$line->id_recette)}"> Lire la suite</a></p>
